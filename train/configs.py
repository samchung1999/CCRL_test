...
def get_configs():
    ...
    #------------------------------------------------------------------------------------------------------------
    parser.add_argument("--destination_strategy", type=str, default="random", help="Strategy to select destinations (random, heuristic, etc.)")
    parser.add_argument("--target_explore_rate", type=float, default=0.95, help="Target exploration rate to achieve in the environment")
    parser.add_argument("--map_type", type=str, default="standard", help="Type of map used in the environment")
